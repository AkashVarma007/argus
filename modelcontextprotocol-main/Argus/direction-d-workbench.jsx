...
function DFoot({ left = '● ready', right = 'draft-2026-v1 · UTF-8 · LF' }) {
  return (
    <div style={{ height: 22, background: DTok.surface, borderTop: `1px solid ${DTok.rule}`, display: 'flex', alignItems: 'center', padding: '0 12px', fontFamily: DTok.mono, fontSize: 10.5, color: DTok.ink2, flexShrink: 0 }}>
      <span style={{ color: DTok.cobalt, fontWeight: 600 }}>{left}</span>
      <span style={{ flex: 1 }} />
      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 8, marginTop: 8 }}>
          {[
            ...
            <div key={n} style={{ height: 60, background: c, padding: '8px 10px', color: c === DTok.ink0 || c === DTok.cobalt ? '#fff' : DTok.ink2, fontFamily: DTok.mono, fontSize: 10, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: c === DTok.surface || c === DTok.paper ? `1px solid ${DTok.rule}` : 'none' }}>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ flex: 1, padding: '24px 32px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 'auto', display: 'flex', gap: 10, alignItems: 'center' }}>
            <button style={{ fontFamily: DTok.sans, fontSize: 14, fontWeight: 700, padding: '12px 22px', background: DTok.cobalt, color: '#fff', border: 'none' }}>Run scan ↵</button>
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 380px', minHeight: 0 }}>
          ...
          <div style={{ padding: '22px 30px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: 22 }}>
              ...
              <div>
                <div style={{ fontFamily: DTok.mono, fontSize: 10.5, color: DTok.cobalt, fontWeight: 600 }}>current · scn-0142</div>
                <div style={{ fontSize: 120, fontWeight: 700, color: DTok.ink0, lineHeight: 0.85, letterSpacing: '-0.05em', fontFamily: DTok.sans }}>B<span style={{ color: DTok.cobalt }}>+</span></div>
                <div style={{ fontFamily: DTok.mono, fontSize: 12, color: DTok.ink2, marginTop: 2 }}>229/243 &nbsp;<span style={{ color: DTok.cobalt, fontWeight: 600 }}>+8</span></div>
              </div>
              <div style={{ flex: 1 }} />
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ marginTop: 6, display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
                  ...
                  <button style={{ fontFamily: DTok.sans, fontSize: 12, fontWeight: 700, padding: '4px 12px', background: DTok.cobalt, color: '#fff', border: 'none' }}>Re-scan ↵</button>
                </div>
              </div>
            </div>
                    ...
                    <div key={n} style={{ display: 'grid', gridTemplateColumns: '140px 1fr 140px', gap: 14, padding: '8px 0', borderBottom: `1px solid ${DTok.ink6}`, alignItems: 'center' }}>
                      ...
                      <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        <span style={{ flex: 1, height: 8, background: DTok.ink6, position: 'relative' }}>
                          ...
                          <span style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: `${(cur / 12) * 100}%`, background: DTok.ink0 }} />
                        </span>
          ...
          <div style={{ background: DTok.surface, borderLeft: `1px solid ${DTok.rule}`, padding: '18px 18px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <button style={{ marginTop: 10, fontFamily: DTok.sans, fontSize: 12.5, fontWeight: 600, padding: '8px 14px', background: DTok.cobalt, color: '#fff', border: 'none' }}>Open first critical →</button>
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '260px 1fr', minHeight: 0 }}>
          ...
          <div style={{ padding: '20px 28px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
              <span style={{ fontFamily: DTok.mono, fontSize: 10, padding: '3px 8px', background: DTok.ink0, color: '#fff', letterSpacing: '0.1em' }}>CRITICAL</span>
  ...
  "error": {
    ...
    "data": {
      ...
      "granted":  ["read"]
                ...
                <pre style={{ margin: 0, padding: '12px 12px', fontSize: 11, lineHeight: 1.55, color: DTok.ink0, background: '#fff', overflow: 'hidden' }}>
{`HTTP/1.1 200 OK
{
  "result": {
    "content": [
      {
        ...
        "text": "wrote 3 lines"
            ...
            <pre style={{ marginTop: 4, padding: '14px 16px', background: DTok.ink0, color: '#dedacb', fontFamily: DTok.mono, fontSize: 11.5, lineHeight: 1.55, flex: 1, overflow: 'hidden' }}>
...
+   }
    return tool.handler(args, ctx);
            ...
            <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
              <button style={{ fontFamily: DTok.sans, fontSize: 12.5, fontWeight: 600, padding: '8px 14px', background: DTok.cobalt, color: '#fff', border: 'none' }}>Open §7.4 →</button>
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '220px 1fr 300px', minHeight: 0 }}>
          ...
          <div style={{ position: 'relative', overflow: 'hidden', background: `
            ...
            <svg viewBox="0 0 700 530" style={{ width: '100%', height: '100%' }} preserveAspectRatio="xMidYMid meet">
              ...
              {/* Router */}
              <g>
                <rect x="360" y="105" width="100" height="50" fill={DTok.ink0} stroke={DTok.ink0} strokeWidth="1" />
                <text x="370" y="121" fontFamily={DTok.mono} fontSize="9" fill={DTok.ink5} letterSpacing="0.1em">ROUTER</text>
                <text x="370" y="139" fontFamily={DTok.sans} fontSize="13" fontWeight="700" fill="#fff">tools/call</text>
              </g>
              {/* Handlers — 8 */}
              {TOOLS_FOR_BUILD.map((t, i) => {
                const y = 70 + i * 40;
          ...
          <div style={{ background: DTok.surface, borderLeft: `1px solid ${DTok.rule}`, padding: '16px 16px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            ...
            <textarea defaultValue="Read a single file from a GitHub repository at the given ref." style={{ marginTop: 4, padding: '7px 9px', fontFamily: DTok.sans, fontSize: 12.5, border: `1px solid ${DTok.rule}`, background: '#fff', resize: 'none', minHeight: 46, boxSizing: 'border-box' }} />

            <div style={{ marginTop: 12, fontFamily: DTok.mono, fontSize: 10, letterSpacing: '0.14em', color: DTok.ink3 }}>INPUT SCHEMA · JSON</div>
            <pre style={{ margin: '4px 0 0', padding: '10px 12px', background: '#fff', border: `1px solid ${DTok.rule}`, fontFamily: DTok.mono, fontSize: 11, lineHeight: 1.55, color: DTok.ink1, overflow: 'hidden' }}>{`{
  "repo": "string",
  "path": "string",
  "ref?": "string"
}`}</pre>
            ...
            <div style={{ marginTop: 'auto', display: 'flex', gap: 8 }}>
              ...
              <button style={{ flex: 1, fontFamily: DTok.sans, fontSize: 12.5, fontWeight: 600, padding: '8px 0', background: DTok.cobalt, color: '#fff', border: 'none' }}>Generate →</button>
            </div>
          </div>
        </div>
      </div>
...
if (import.meta.main) server.listen();`}
            ...
            <div style={{ padding: '14px 22px', borderTop: `1px solid ${DTok.rule}`, background: DTok.paper, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 18, alignItems: 'center' }}>
              ...
              <button style={{ fontFamily: DTok.sans, fontSize: 14, fontWeight: 700, padding: '12px 22px', background: DTok.cobalt, color: '#fff', border: 'none' }}>↓ Download .zip · 11.7 kB</button>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: DTok.paper, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '240px 1fr 280px', minHeight: 0 }}>
          ...
          {/* Tree */}
          <div style={{ borderRight: `1px solid ${DTok.rule}`, padding: '14px 12px', overflow: 'hidden', background: DTok.surface, fontFamily: DTok.mono, fontSize: 11 }}>
            <input placeholder="search spec…" style={{ width: '100%', padding: '6px 8px', fontFamily: DTok.mono, fontSize: 11, border: `1px solid ${DTok.rule}`, background: '#fff', boxSizing: 'border-box' }} />
    ...
    "data": { "required": ["write"], "granted": ["read"] }
          ...
          <div style={{ background: DTok.surface, borderLeft: `1px solid ${DTok.rule}`, padding: '18px 16px', overflow: 'hidden', fontFamily: DTok.mono, fontSize: 11 }}>
            ...
            <div style={{ marginTop: 18, padding: 12, background: '#fff', border: `1px solid ${DTok.cobalt}`, fontFamily: DTok.sans }}>
              ...
              <button style={{ marginTop: 8, fontSize: 12, fontWeight: 600, padding: '6px 10px', background: DTok.cobalt, color: '#fff', border: 'none' }}>← Back to report</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 0 }}>
          ...
          <div style={{ padding: '36px 36px', borderRight: `1px solid ${DTok.rule}`, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginTop: 'auto', display: 'flex', gap: 8 }}>
              <input placeholder="paste an endpoint…" style={{ flex: 1, padding: '11px 14px', fontFamily: DTok.mono, fontSize: 13, border: `1px solid ${DTok.ink3}`, background: '#fff', boxSizing: 'border-box' }} />
              <button style={{ fontFamily: DTok.sans, fontSize: 13.5, fontWeight: 700, padding: '11px 18px', background: DTok.cobalt, color: '#fff', border: 'none' }}>Scan ↵</button>
            </div>
          </div>

          <div style={{ padding: '36px 36px', display: 'flex', flexDirection: 'column' }}>
            <div style={{ fontFamily: DTok.mono, fontSize: 10.5, color: DTok.ink0, background: DTok.ink0, padding: '3px 8px', alignSelf: 'flex-start', color: '#fff', letterSpacing: '0.12em' }}>ABORTED · SCN-0143</div>
            ...
            <div style={{ marginTop: 'auto', display: 'flex', gap: 10 }}>
              <button style={{ fontFamily: DTok.sans, fontSize: 13.5, fontWeight: 700, padding: '11px 18px', background: DTok.cobalt, color: '#fff', border: 'none' }}>Retry ↵</button>
