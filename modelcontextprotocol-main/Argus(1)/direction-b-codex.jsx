...
const BTok = {
  // Records-room dark archival. Keep "serif" token name for backwards compat,
  // but it's now sans — clean Inter throughout. Italics still carry quotation.
  serif: '"Inter", system-ui, sans-serif',
  sans: '"Inter", system-ui, sans-serif',
  mono: '"JetBrains Mono", ui-monospace, monospace',
  oxblood: '#e8a23a',        // re-purposed: warm amber (the lamp on the desk)
  oxbloodDim: '#3a2810',
  paper: '#100c08',          // warm near-black
  rule:  '#23180e',
  ink0: '#f4ecd6',
  ink1: '#d6cdb1',
  ink2: '#a39a7d',
  ink3: '#75694b',
  ink4: '#4a4128',
  ink5: '#2a2113',          // hairline
  ink6: '#1b1409',
  surface1: '#170f08',      // elevated card
  surface2: '#1e1610',      // raised
  glow: 'rgba(232,162,58,0.4)',
};
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 22 }}>
        <span style={{ fontFamily: BTok.serif, fontSize: 22, fontWeight: 600, letterSpacing: -0.3, color: BTok.ink0, display: 'inline-flex', alignItems: 'baseline', gap: 10 }}>
          <LiveDot color={BTok.oxblood} size={6} dur="2.2s" />
          <span style={{ fontStyle: 'italic' }}>Argus</span>
          <span style={{ fontVariant: 'small-caps', fontSize: 12, letterSpacing: '0.1em', color: BTok.ink3 }}>—— mcp inspector</span>
        </span>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1.4fr 1fr', minHeight: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <div style={{ padding: '22px 28px', borderBottom: `1px solid ${BTok.ink5}` }}>
            ...
            <button style={{ marginTop: 10, fontFamily: BTok.serif, fontSize: 14, padding: '8px 16px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>Begin examination →</button>
          </div>
    ...
    <div style={{ width: '100%', height: '100%', background: BTok.paper, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '28px 60px 28px 36px', overflow: 'hidden' }}>
        ...
        <div style={{ marginTop: 22, display: 'flex', alignItems: 'center', gap: 16 }}>
          <button style={{ fontFamily: BTok.serif, fontSize: 16, padding: '10px 22px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>Begin examination ↵</button>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 380px', minHeight: 0 }}>
        ...
        <div style={{ padding: '24px 36px', overflow: 'hidden', borderRight: `1px solid ${BTok.ink5}`, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 14, height: 3, background: BTok.ink6, position: 'relative' }}>
            <div style={{ position: 'absolute', inset: 0, width: '44%', background: BTok.oxblood }} />
          </div>
        ...
        {/* Right: marginalia */}
        <div style={{ padding: '24px 28px', overflow: 'hidden', background: BTok.surface1 }}>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1.05fr 1fr', minHeight: 0 }}>
        ...
        <div style={{ padding: '28px 44px 28px 36px', borderRight: `1px solid ${BTok.ink5}`, overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{ marginTop: 26, borderTop: `2px double ${BTok.rule}`, borderBottom: `2px double ${BTok.rule}`, padding: '26px 0', position: 'relative' }}>
            ...
            {/* warm lamp behind the verdict */}
            <div style={{
              position: 'absolute', top: 30, left: -30, width: 320, height: 320,
              background: `radial-gradient(circle, ${BTok.oxblood}38 0%, transparent 60%)`,
              pointerEvents: 'none', animation: 'argus-breathe 5s ease-in-out infinite',
            }} />
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 18, marginTop: 6, position: 'relative', zIndex: 1 }}>
              <div style={{
                fontFamily: BTok.serif, fontSize: 180, lineHeight: 0.78, fontWeight: 700, color: BTok.oxblood,
                letterSpacing: '-0.04em',
                ['--g']: BTok.glow, animation: 'argus-glow 5s ease-in-out infinite',
              }}>B+</div>
              <div>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 22 }}>
            <button style={{ fontFamily: BTok.serif, fontSize: 13, padding: '8px 14px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>Download report.html</button>
            ...
            <span style={{ flex: 1 }} />
            <button style={{ fontFamily: BTok.serif, fontSize: 13, padding: '8px 14px', background: BTok.oxblood, color: BTok.surface1, border: 'none' }}>Re-examine ↵</button>
          </div>
        </div>
          ...
          <div style={{ marginTop: 16, borderTop: `1px solid ${BTok.ink2}` }}>
            {CHECKS.Auth.filter(c => c[1]==='fail').map((c, i) => (
              <div key={c[0]} style={{
                ...
                background: i === 0 ? BTok.surface1 : 'transparent',
        ...
        <div style={{ padding: '28px 44px 28px 36px', overflow: 'hidden' }}>
          ...
          <div style={{ marginTop: 18, display: 'grid', gridTemplateColumns: '40px 1fr 1fr', gap: 18 }}>
            ...
            <div>
              ...
              <pre style={{ margin: '4px 0 0', padding: '12px 14px', background: BTok.surface1, fontFamily: BTok.mono, fontSize: 10.5, lineHeight: 1.6, color: BTok.ink1, overflow: 'hidden' }}>{`POST /mcp
...
// tool requires = ["write"]`}</pre>
            ...
            <div>
              ...
              <pre style={{ margin: '4px 0 0', padding: '12px 14px', background: BTok.surface1, borderLeft: `3px solid ${BTok.oxblood}`, fontFamily: BTok.mono, fontSize: 10.5, lineHeight: 1.6, color: BTok.ink1, overflow: 'hidden' }}>{`HTTP/1.1 200 OK
{ "result": {
    "content": [{
      "type": "text",
      "text": "wrote 3 lines"
...
// expected: -32002 insufficient_scope`}</pre>
          ...
          <div style={{ marginTop: 18, display: 'grid', gridTemplateColumns: '40px 1fr', gap: 18 }}>
            ...
            <div>
              ...
              <pre style={{ margin: '4px 0 0', padding: '12px 14px', background: BTok.oxblood, color: BTok.paper, fontFamily: BTok.mono, fontSize: 11, lineHeight: 1.6, overflow: 'hidden' }}>{`// before tools/call dispatch
...
function B_BuildCanvas() {
          ...
          <div style={{ marginTop: 22, borderTop: `2px double ${BTok.rule}`, paddingTop: 14 }}>
            ...
            <div style={{ marginTop: 14, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 22 }}>
              ...
              <div>
                ...
                <pre style={{ margin: '6px 0 0', padding: '12px 14px', background: BTok.surface1, fontFamily: BTok.mono, fontSize: 11, lineHeight: 1.55, color: BTok.ink1, overflow: 'hidden' }}>{`export async function repoReadFile(args, ctx) {
  ...
  return { content: raw.toString('utf8') };
        ...
        <div style={{ padding: '24px 24px', overflow: 'hidden', borderLeft: `1px solid ${BTok.ink5}`, background: BTok.surface1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: 8 }}>
            <button style={{ fontFamily: BTok.serif, fontSize: 14, padding: '10px 14px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>Generate &amp; review →</button>
      ...
      <div style={{ flex: 1, padding: '24px 36px', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 36, minHeight: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 22, display: 'flex', flexDirection: 'column', gap: 8 }}>
            <button style={{ fontFamily: BTok.serif, fontSize: 16, padding: '14px 18px', background: BTok.oxblood, color: BTok.paper, border: 'none', textAlign: 'left' }}>↓ &nbsp; Send down · github-readonly.zip</button>
    ...
    <div style={{ width: '100%', height: '100%', background: BTok.paper, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '260px 1fr 280px', minHeight: 0 }}>
        ...
        <div style={{ padding: '20px 22px', overflow: 'hidden', borderRight: `1px solid ${BTok.ink5}` }}>
          <input placeholder="⌘K search the spec…" style={{ width: '100%', padding: '8px 10px', fontFamily: BTok.serif, fontStyle: 'italic', fontSize: 13, border: `1px solid ${BTok.ink2}`, background: BTok.surface1, boxSizing: 'border-box' }} />
        ...
        <div style={{ padding: '24px 44px', overflow: 'hidden' }}>
          ...
          <pre style={{ marginTop: 6, padding: '14px 16px', background: BTok.surface1, fontFamily: BTok.mono, fontSize: 12, lineHeight: 1.55, color: BTok.ink1, overflow: 'hidden' }}>{`{
  "error": {
    "code": -32002,
    ...
    "data": { "required": ["write"], "granted": ["read"] }
        ...
        <div style={{ padding: '24px 22px', borderLeft: `1px solid ${BTok.ink5}`, background: BTok.surface1, overflow: 'hidden' }}>
          ...
          <div style={{ marginTop: 22, padding: '14px 14px', border: `1px solid ${BTok.oxblood}`, background: BTok.paper }}>
            ...
            <button style={{ marginTop: 8, fontFamily: BTok.serif, fontSize: 12.5, padding: '6px 12px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>← Return to report</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 0 }}>
        ...
        <div style={{ padding: '36px 40px', borderRight: `1px solid ${BTok.ink5}`, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 20, display: 'flex', gap: 10 }}>
            <input placeholder="http://localhost:3845/mcp" style={{ flex: 1, padding: '12px 14px', fontFamily: BTok.mono, fontSize: 13, border: `1px solid ${BTok.ink2}`, background: BTok.surface1, boxSizing: 'border-box' }} />
            <button style={{ fontFamily: BTok.serif, fontSize: 14, padding: '12px 22px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>Begin ↵</button>
          </div>
        ...
        <div style={{ padding: '36px 40px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 24, display: 'flex', gap: 10 }}>
            <button style={{ fontFamily: BTok.serif, fontSize: 14, padding: '10px 18px', background: BTok.oxblood, color: BTok.paper, border: 'none' }}>Retry ↵</button>
