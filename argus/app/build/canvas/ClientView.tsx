...
export default function ClientView() {
  ...
  if (!build) {
    return (
      <section className={styles.missing} data-argus="build-missing">
        <EmptyState
          heading={buildId ? `Build ${buildId} not found` : 'No build selected'}
          description="This build may have been deleted, or the link is stale. Open one of your existing builds or start a new one."
          ctaLabel="Back to builds"
          ctaHref="/build"
        />
      </section>
    )
